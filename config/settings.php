...
return [
    ...
    'permisos' => [
        ...
        [
            ...
            'display_name'  => 'Crear Operador',
            'description'   => 'Permite Crear un operador'
        ],
        [
            'name'          => 'operator_edit',
            'display_name'  => 'Editar Operador',
            'description'   => 'Permite Editar un operador'
        ],
        [
            'name'          => 'operator_show',
            'display_name'  => 'Ver Operador',
            'description'   => 'Permite ver el detalle de un operador'
        ],
        [
            'name'          => 'operator_delete',
            'display_name'  => 'Eliminar operador',
            'description'   => 'Permite Eliminar un operador'
        ],
        [
        ...
        [
            'name'          => 'sucursal_access',
            'display_name'  => 'Aceso Sucursal',
            'description'   => 'Acceso el acceso a las sucursales'
        ],
        [
            'name'          => 'tipo_hardware_access',
            'display_name'  => 'Acceso tipo Hardware',
            'description'   => 'Acceso al catálogo tipo de hardware'
        ],
        [
            'name'          => 'hardware_access',
            'display_name'  => 'Acceso hardware',
            'description'   => 'Acceso al catalogo hardware'
        ],
        [
            'name'          => 'equipos_access',
            'display_name'  => 'Acceso Equipos',
            'description'   => 'Acceso al catalogo de equipos'
        ],
        [
            'name'          => 'personal_access',
            'display_name'  => 'Acceso Personal',
            'description'   => 'Acceso al catalogo de personal'
        ],
        [
        ...
        [
            'name'          => 'reporte_anual_impresiones_access',
