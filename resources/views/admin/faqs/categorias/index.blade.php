            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="card-tools">
                        <a href="{{ route('admin.faqs.categorias.create') }}"
                ...
                <div class="card-body">
                    <table id="tb-categorias" class=" table table-bordered table-striped table-hover datatable datatable-User">
                        <thead>
                            <tr>
                                <th>ID </th>
                                <th>NOMBRE</th>
    ...
    <script type="text/javascript">
        $(function() {
            ...
            var dt = dom.table.DataTable({
                ...
                ajax: {
                    url: "{{ route('admin.faqs.categorias.datatables') }}",
                    type: "POST",
                    data: function (d) {
                    },
