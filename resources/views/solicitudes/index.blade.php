                            ...
                            <tr>
                                ...
                                <td>
                                        ...
                                        @permission('solicitude_edit')
                                            <a class="btn btn-sm btn-info" href="{{ route('solicitudes.edit', $element->id) }}" title="Editar">
                                                {{-- {{ trans('global.edit') }} --}}
                                        ...
                                        @permission('solicitude_delete')
                                            <form action="{{ route('solicitudes.destroy', $element->id) }}" method="POST" onsubmit="return confirm('Deseas eliminar el registro');" style="display: inline-block;">
