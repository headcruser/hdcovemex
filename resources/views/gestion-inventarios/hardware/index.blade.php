    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                <h3 class="card-title">Gestion de hardware</h3>
                    <div class="card-tools">
                        <a href="{{ route('gestion-inventarios.hardware.create') }}" class="btn btn-success btn-sm" title="Crear">
                ...
                <!-- /.card-header -->
                <div class="card-body">
                    <table id="tb-hardware" class="table table-bordered table-hover table-striped">
                        <thead>
                            <tr>
                                <th>#</th>
                                <th>Descripcion</th>
